...
{for(var i = 0, len = gdjs.GameOverCode.GDKeyboardObjects1.length ;i < len;++i) {
    gdjs.GameOverCode.GDKeyboardObjects1[i].setString(gdjs.evtTools.common.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(0)));
}
}}
...
};gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDOkButtonObjects1Objects = Hashtable.newFrom({"OkButton": gdjs.GameOverCode.GDOkButtonObjects1});gdjs.GameOverCode.userFunc0x799560 = function(runtimeScene) {
"use strict";

var playerName = runtimeScene.getVariables().get("JS_NameToSend").getAsString();
var playerScore = runtimeScene.getVariables().get("JS_ScoreToSend").getAsString();
var targetURL = "https://cors.io/?https://apis3.uzone.id/api/addSC/A-c84erqsCqq";
...
gdjs.GameOverCode.userFunc0x799560(runtimeScene);
...
gdjs.GameOverCode.GDOkButtonObjects1.createFrom(runtimeScene.getObjects("OkButton"));

gdjs.GameOverCode.condition0IsTrue_0.val = false;
gdjs.GameOverCode.condition1IsTrue_0.val = false;
{
gdjs.GameOverCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDOkButtonObjects1Objects, runtimeScene, true, false);
}if ( gdjs.GameOverCode.condition0IsTrue_0.val ) {
{
...
/* Reuse gdjs.GameOverCode.GDOkButtonObjects1 */
{for(var i = 0, len = gdjs.GameOverCode.GDOkButtonObjects1.length ;i < len;++i) {
    gdjs.GameOverCode.GDOkButtonObjects1[i].deleteFromScene(runtimeScene);
}
