...
gdjs.TestSceneCode.userFunc0x68d500 = function(runtimeScene) {
"use strict";
var output = runtimeScene.getVariables().get("Output");
var date = new Date();
...
var stampUnixtime = Date.now();
var stampTime = date.getFullYear()+"-"+date.getMonth()+"-"+date.getDate()+""+date.getHours()+""+date.getMinutes()+"abcd" ;

output.setString(stampTime);
};
...
gdjs.TestSceneCode.userFunc0x68d500(runtimeScene);
